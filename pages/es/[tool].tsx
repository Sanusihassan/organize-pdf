...
import { OrganizePDFHOWTO_es } from "@/src/how-to";
    ...
    <>
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(OrganizePDFHOWTO_es),
          }}
        />
      ...
      <div className="container">
        <HowTo howTo={OrganizePDFHOWTO_es} alt={item.seoTitle} imgSrc={item.to.replace("/", "")} />
      </div>
