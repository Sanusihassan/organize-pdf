...
import { OrganizePDFHOWTO_ar } from "@/src/how-to";
    ...
    <>
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(OrganizePDFHOWTO_ar),
          }}
        />
      ...
      <div className="container">
        <HowTo howTo={OrganizePDFHOWTO_ar} alt={item.seoTitle} imgSrc={item.to.replace("/", "")} />
      </div>
