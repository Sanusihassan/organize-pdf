...
import { OrganizePDFHOWTO } from "@/src/how-to";
...
export default ({ item, initialPremiumStatus }: { item: _tool["Organize_PDF"]; initialPremiumStatus: boolean }) => {
    ...
    <>
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(OrganizePDFHOWTO),
          }}
        />
      ...
      <div className="container">
        <HowTo howTo={OrganizePDFHOWTO} alt={item.seoTitle} imgSrc={item.to.replace("/", "")} />
      </div>
