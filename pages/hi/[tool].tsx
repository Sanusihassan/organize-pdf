...
import { OrganizePDFHOWTO_hi } from "@/src/how-to";
    ...
    <>
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(OrganizePDFHOWTO_hi),
          }}
        />
      ...
      <div className="container">
        <HowTo howTo={OrganizePDFHOWTO_hi} alt={item.seoTitle} imgSrc={item.to.replace("/", "")} />
      </div>
